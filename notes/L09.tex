...
Looking at the execution, the last path condition occurred at (2) where we had \texttt{x < 5}. We therefore form the new path condition
...
\end{tikzpicture}
\end{center}
Because we don't run the then-case of (2), this is the end of the execution for \texttt{proc(6)}, and
...
\texttt{a[0] != 1234...} and add it to our constraints to solve.
